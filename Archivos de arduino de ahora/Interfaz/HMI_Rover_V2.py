...
class HMIRoverRockerBogie:
    ...
    def preset_point_turn(self):
        # Ángulos tangenciales al círculo centrado en el rover
        # Delantero Izq: 135°, Delantero Der: 45°, Trasero Izq: 45°, Trasero Der: 135°
        self.ang_s1.set(135)
        self.ang_s2.set(45)
        self.ang_s3.set(45)
        self.ang_s4.set(135)
        ...
        self.log_consola("Geometría configurada para Giro sobre su propio eje (360° Point Turn).")

    def preset_cangrejo(self):
        # Todas las esquinas a 45° paralelas
        self.ang_s1.set(135)
        self.ang_s2.set(135)
        self.ang_s3.set(135)
        self.ang_s4.set(135)
